const CACHE_NAME = 'atlas-ledneva-v2.7';
const STATIC_CACHE_NAME = 'atlas-static-v2.7';
const IMAGES_CACHE_NAME = 'atlas-images-v2.7';
const DATA_CACHE_NAME = 'atlas-data-v2.7';
